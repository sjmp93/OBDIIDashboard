...
public class ObdReading {
    ...
    public ObdReading(double latitude, double longitude, double altitude, /*long timestamp*/ float timestamp,
    ...
    public /*long*/float getTimestamp() {
        return timestamp;
    }
